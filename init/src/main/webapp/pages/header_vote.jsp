...
<link rel="stylesheet" href="<b:staticUrl>/res/css/package/vote/swiper.min.css</b:staticUrl>">
<script type="text/javascript" src="<b:staticUrl>/res/js/package/vote/swiper.min.js</b:staticUrl>"></script>
<%-- <script src="<b:staticUrl>/res/js/package/vote/flexible.js</b:staticUrl>"></script> --%>
<link rel="stylesheet" href="<b:staticUrl>/res/css/package/vote/animate.css</b:staticUrl>">
<link rel="stylesheet" href="<b:staticUrl>/res/css/package/vote/style.css</b:staticUrl>">
<link rel="stylesheet" href="<b:staticUrl>/res/css/package/vote/aa.css</b:staticUrl>">
