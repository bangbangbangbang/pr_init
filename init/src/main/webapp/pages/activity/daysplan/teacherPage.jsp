...
<body id="bgwhite">
	<div class="expert" style="background-image:url(<b:staticUrl>/res/img/activity/BG-tutorimg.png</b:staticUrl>);">
		<div class="expert-info">
			<div class="photo"><img src="${albumUrl}" ></div>
			<div class="font17 name"><c:out value="${nickName}"></c:out><i class="i-girl"></i></div>
	...
	<p style="text-indent:26px;"><c:out value="${declaration}"></c:out> </p>
	</div>
