...
<div class="mainWrap">
<div id="headDiv" class="section" style="padding:0;">
	<div  style="min-height: 3rem;position: relative;">
		...
		<div style="position: absolute;bottom: 0rem;color: white;padding: 0.32rem 0.32rem;  background: rgba(3,3,3,0.2); width: 100%;">
			...
			<div  class="showmoreinfo" onclick="showmoreinfo(this)" style="width: 100%;text-align: center;">
				<img style="margin: 0 auto;" src="<b:staticUrl>/res/img/jiantou1.png</b:staticUrl>" ></img>
			</div>
		</div>
	</div>
	<div class="moreinfo" style="display: none;width: 100%;">
		<%@include file="./index_content.jsp"%>
	<div style="width: 100%;text-align: center;">
		<img onclick="hidemoreinfo()" style="margin: 0 auto;" src="<b:staticUrl>/res/img/jiantou2.png</b:staticUrl>" ></img>
	</div>
	</div>
</div>
            ...
            <div style="margin-top: 0.6rem;">		
         			<table class="canplay">
         				<tr>
         					...
         					<c:choose>
         						<c:when test="${hasAuth=='true'}">
         							<td width="33.33%" align="center"><span class="fenxiang2">请朋友听</span></td>
         						</c:when>
         						<c:otherwise>
...
<script type="text/javascript">
 ...
 $(function(){
	 ...
	 $(".kechenglist").click(function(){
		 ...
		 $("#drag").css("left","0px");
		 var o = $(this);
		 $(".fenxiang2").on("click",function(){
			 HH.href("/yzmm/account/course/topic/toShare?id=${id}&courseId="+o.data("id"));
		 })
		 if(o.data("play")){
			 initplay(true,o);
			 return;
