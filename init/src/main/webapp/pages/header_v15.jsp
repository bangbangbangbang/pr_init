...
<%-- 音频等样式出问题 单引 --%>
<%-- <link rel="stylesheet" href="<b:staticUrl>/res/css/group-v1.1.css</b:staticUrl>"> --%>
<link rel="stylesheet" href="<b:staticUrl>/res/css/activity-v1.1.css</b:staticUrl>">
<link rel="stylesheet" href="<b:staticUrl>/res/css/login.css</b:staticUrl>">

<script src="<b:staticUrl>/res/js/imgshow.js</b:staticUrl>"></script>
<script src="<b:staticUrl>/res/js/flexible.js</b:staticUrl>"></script>
<script src="<b:staticUrl>/res/js/h5_slide.js</b:staticUrl>"></script>
