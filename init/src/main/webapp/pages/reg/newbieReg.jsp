...
<body id="bgwhite">
<form id="activeForm" action="/yzmm/account/newbie/userReg" onSubmit="return sub()">
	...
	<div class="font15 form">
		...
		<div class="item form-item">
			...
			<div class="item-tit" >
				<a href="javascript:void(0)" style="color: black;display: ${not empty info.telephone ? 'none' : 'block'}"
		...
		<div class="item form-item">
			...
			<div class="item-cont">
				<span class="radio"><i class="i-radio i-radioactive"></i><i >宝妈</i></span>
				<!-- <span class="radio"><i class="i-radio"></i><i >孕妈</i></span> -->
				<span class="radio"><i class="i-radio"></i><i >奶爸</i></span>
				<span class="radio other"><i class="i-radio"></i><i>其他</i></span>
			</div>
		</div>	
	</div>
	...
	<script type="text/javascript">
		function active() {
			...
			HH.ajax({
				...
				callback:function(data){
					if(data.success){
						toast("请稍后,即将进入会员介绍页",function(){
							window.location.href="/yzmm/account/newbie/toNewbiePrePay";
						});
					}else{
						//已经激活
						if(100052 == data.code){
