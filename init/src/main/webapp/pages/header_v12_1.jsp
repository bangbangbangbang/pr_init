...
<link rel="stylesheet" href="<b:staticUrl>/res/css/style-v1.2.1.css</b:staticUrl>">
<link rel="stylesheet" href="<b:staticUrl>/res/css/main-v1.2.1.css</b:staticUrl>">
<link rel="stylesheet" href="<b:staticUrl>/res/css/our-v1.2.1.css</b:staticUrl>">
...
<script type="text/javascript" src="<b:staticUrl>/res/js/web-v1.2.1.js</b:staticUrl>"></script>
<script type="text/javascript" src="<b:staticUrl>/res/js/main-v1.2.1.js</b:staticUrl>"></script>
